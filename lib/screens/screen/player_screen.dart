...
class _AudioPlayerViewState extends State<AudioPlayerView>
  ...
  double _dragStartY = -1;
  bool _shouldHandleSwipe = false;
    ...
    return Shortcuts(
      ...
      child: Actions(
        actions: {
          ...
          LoopPlaylistIntent: CallbackAction<LoopPlaylistIntent>(onInvoke: (intent) {
          ...
          LoopSingleIntent: CallbackAction<LoopSingleIntent>(onInvoke: (intent) {
            musicPlayer.setLoopMode(LoopMode.one);
            return null;
          }),
          TimerIntent: CallbackAction<TimerIntent>(onInvoke: (intent) {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const TimerView()));
            return null;
          }),
        ...
        child: FocusScope(
          ...
          child: GestureDetector(
            ...
            onVerticalDragStart: (details) {
              ...
              _shouldHandleSwipe = true; // allow from anywhere on screen
            },
            onVerticalDragUpdate: (details) {
              if (_dragStartY < 0) _dragStartY = details.globalPosition.dy;
              if (!_shouldHandleSwipe) return;
              ...
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    icon: const Icon(MingCute.more_2_fill, size: 25, color: Default_Theme.primaryColor1),
                  ),
                ],
                title: Column(
                  children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: UpNextPanel(panelController: _panelController),
                              ),
                            ),
                          ),
                        ],

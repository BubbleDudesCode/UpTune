        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Music Streaming on an other Level.',
              ...
              Wrap(
                ...
                children: [
                  ...
                  _InfoPill(
                      icon: FontAwesome.discord_brand,
                      text: 'Discord',
                      tooltip: 'UpTune Discord',
                      onTap: () {
                        launchUrl(
                          Uri.parse('https://discord.gg/386u9QzPPb'),
                        );
                      }),
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text(
            "Support UpTune to keep it growing!",
        ...
        const Text(
          'I want UpTune to keep improving.',
          textAlign: TextAlign.center,
          style: TextStyle(color: kSecondaryTextColor, fontSize: 14),
        ),
      ],
